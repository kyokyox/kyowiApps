  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        _block('Browser', [
          const Text('Mesin Pencari Default',
          ...
          Container(
            ...
            child: DropdownButton<SearchEngine>(
              ...
              items: SearchEngine.values
                  ...
                  .toList(),
              onChanged: (v) => setState(() => settings.searchEngine = v!),
            ),
          ),
          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'Data Saver (blokir gambar & auto-play video) bisa diaktifin langsung dari toolbar di halaman Web.\n\nMau koneksi lebih private / kadang kebentur blokir DNS ISP? Buka Pengaturan HP → Jaringan & Internet → cari "DNS Pribadi" → isi dengan "dns.google" atau "1dot1dot1dot1.cloudflare-dns.com".',
                    style: TextStyle(color: AppColors.gray, fontSize: 10.5, height: 1.5),
                  ),
                ),
              ],
            ),
