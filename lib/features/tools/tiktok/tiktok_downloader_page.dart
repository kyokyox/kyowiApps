...
class _TikTokDownloaderPageState extends State<TikTokDownloaderPage>
  ...
  Future<void> _download({required bool audioOnly}) async {
    ...
    try {
      ...
      if (audioOnly) {
        // Audio bukan tipe media galeri -> tetap simpan di folder app Kyowi.
        ...
        await Gal.putVideo(tempFile.path, album: 'Kyowi');
        await tempFile.delete();

        setState(() => _savedMessage = '✓ Video tersimpan di Galeri (album "Kyowi")');
      }
    } catch (e) {
