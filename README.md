...
Buka github.com → New repository → kasih nama `kyowiApps` → biarin
...
git init
git add .
git commit -m "Initial commit Kyowi"
git branch -M main
git remote add origin https://github.com/kyokyox/kyowiApps.git
